...
def main():
    try:
        ...
        products_df = pd.read_csv('dataset/products.csv').where(pd.notnull(pd.read_csv('dataset/products.csv')), None)
        insert_data(
            cursor, products_df,
            """
        ...
        orders_df = pd.read_csv('dataset/orders.csv').where(pd.notnull(pd.read_csv('dataset/orders.csv')), None)
        insert_data(
            cursor, orders_df,
            """
            INSERT INTO orders 
        ...
        users_df = pd.read_csv('dataset/users.csv').where(pd.notnull(pd.read_csv('dataset/users.csv')), None)
        insert_data(
            cursor, users_df,
            """
            INSERT INTO users 
        ...
        order_items_df = pd.read_csv('dataset/order_items.csv').where(pd.notnull(pd.read_csv('dataset/order_items.csv')), None)
        insert_data(
            cursor, order_items_df,
            """
        ...
        inventory_items_df = pd.read_csv('dataset/inventory_items.csv').where(pd.notnull(pd.read_csv('dataset/inventory_items.csv')), None)
        insert_data(
            cursor, inventory_items_df,
            """
        ...
        distribution_centers_df = pd.read_csv('dataset/distribution_centers.csv').where(pd.notnull(pd.read_csv('dataset/distribution_centers.csv')), None)
        insert_data(
            cursor, distribution_centers_df,
            """
